...
//Завдання 3: Створіть функцію, що повертає новий об'єкт 
//з тими ж властивостями, що й переданий у якості аргумента об'єкт.
...
let user = {
  name: "John",
  age: 25,
  // Створюємо метод introduce,
  // який за допомогою ключового слова this має повернути такий рядок
  introduce: function () {
...
function destructureObject(obj) {
  // Використовуємо деструктуризацію для створення
  //нових змінних з властивостей об'єкту і отримуємо з нього змінні brand та model
  let { brand, model } = obj;
...
// Завдання 10: Змініть значення полів об'єкту, 
//що знаходяться в масиві об'єктів.

// Створюємо масив об'єктів userList, першим 
//елементом якого буде об'єкт name:"Jack",role:"reader", 
...
function printProductDetails(obj) {
  // Використовуємо деструктуризацію для 
  //отримання значень productName, price 
  ...
  // Виводимо productName, price, companyNanme та country на консоль
...
// Завдання 12: Показати, що об'єкти будуть дорівнювати один одному лише тоді,коли одному об'єкту присвоїти значення іншого. Створіть об'єкт два об'єкти planet1 та planet2 з полями   name: "Земля",radius: 6371,
